...
$dados = db_dados("
	SELECT 
		tbagenda.*,
		DATE_FORMAT(tbagenda.data,'%d/%m/%Y às %H:%i')  as data1 
	FROM 
		tbagenda
...
<div class="acessibilidade">
	/ Agenda / <?=utf8_decode($dados['titulo']);?>	<div style="float:right; font-size:12px;"><a href="javascript:DoPrinting();">Imprimir</a></div>
</div>
<div class="interna">
...
<div class='imginterna'>
	<? if (strlen($dados['imagem'])>0) { ?><img src="<?=utf8_decode($dadosconfig['url']);?>/arquivos/agenda/<?=$dados['imagem'];?>"><? } ?>
</div>
