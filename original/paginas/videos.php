...
<div class="acessibilidade">
	/ Vídeos / <?=utf8_decode($dados['categoria']);?> 
</div>
<div class="interna">

 
<div class="titInterna" style="margin-top:0;"><span style="color:#ccc;">Vídeos:</span> <?=utf8_decode($dados['categoria']);?></div>
...
<?
$i=0;
$SQL = "SELECT *, DATE_FORMAT(data,'%d/%m/%Y') as data1 FROM tbvideos WHERE id_categoria=".utf8_decode($dados['id_categoria'])." ORDER BY id_video DESC";
