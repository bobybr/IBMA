...
<title>Magnis Hospedagem ilimitada - www.magnis.com.br</title>
...
<!-- INÍCIO DA ESQUERDA COM MENUS ETC -->
        <div id="left">
...
<!-- LOGADO -->
            <div id="userbox">
                ...
                <ul>
                    ...
                    <li><a href="configuracoes_dados.php?ID=1" title="Configura&ccedil;&otilde;es"><img src="../images/icons/icon_cog.png" alt="Configurações" /></a></li>
                    <? } ?>
					<? if ($_SESSION['Admin']['id_usuario']>=2) { ?>
...
<!-- BOTÕES TOPO ADMIN -->  
            <ul id="topbtns">
            	<li class="desc"><strong>Servi&ccedil;os:</strong><br />Sistema Magnis</li>
            <!--    <li>
                ...
                <li>
                	<a href="#"><img src="../images/icons/icon_lrg_media.png" alt="Pagar fatura" /><br />Fatura</a>
                </li>
                <li>
                	<a href="#"><img src="../images/icons/icon_lrg_comment.png" alt="Comment" /><br />Novidades</a>
                </li>
                <li>
                	<a href="_faq.php"><img src="../images/icons/icon_lrg_support.png" alt="Suporte técnico" /><br />Perguntas</a>
                </li>
            </ul>
<!-- FIM DOS BOTÕES -->  
